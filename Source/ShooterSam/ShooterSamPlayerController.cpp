...
void AShooterSamPlayerController::BeginPlay()
{
	...
	//utwórz widget funkcja szablonowa <typ klasy który próbujemy utworzyc>(obiekt właściciela, obiekt UClass)

	if (HUDWidget)
	{
		HUDWidget->AddToPlayerScreen(0);
		//dodajemy widget do ekranu gracza 0 czyli nas bo singleplayer gierka
	}
}
